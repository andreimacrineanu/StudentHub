            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds: dataSnapshot.getChildren()) {
                    for(DataSnapshot child : ds.getChildren()){
                        ...
                        StorageReference imgReference = storageReference.child("images").child(Utils.currentUser.getUID()).child(child.getValue(String.class)).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            @Override
                            public void onSuccess(Uri uri) {
                                Bitmap bitmap = MediaStore.Images.Media.getBitmap(App.getInstance(), uri);
